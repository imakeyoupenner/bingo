...
$(document).ready(function() {
	...
	var timecounterStart = new Date();
	var winChecker = false;
	...
	if ($(this).data('value') == 1) {
		...
		if (row1 == 5 || row2 == 5 || row3 == 5 || row4 == 5 || row5 == 5 || col1 == 5 || col2 == 5 || col3 == 5  || col4 == 5  || col5 == 5 || diag1 == 5 || diag2 == 5) {
			if( winChecker == false){
				var timecounterEndms = new Date() - timecounterStart; // miliseconds
				var timecounterEnd = timecounterEndms/1000/60; // in Minuten
				$('#header').html("Bingo! Nach " + timecounterEnd.toFixed(2) + " Minuten");				
	         		winSnd.play();
				winChecker = true;
			}
			$('#header').addClass("win");
